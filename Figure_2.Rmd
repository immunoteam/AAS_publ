...
mutations = readRDS("/Users/matemanczinger/Documents/Projektek/mutational_signatures/_toolarge/MM_mutations_full_GDC_grch38.rds") #File found on the Zenodo repository
...
#### Simulating the effect of each of the 192 mutation profile by generating 1000 missense mutations
load("/Users/matemanczinger/Documents/Projektek/mutational_signatures/clean_mutational_signatures/aa_changes_0916")
#######################

#### Associating mutation profiles with AASs
result = readRDS(paste0("common_objects/MM_substitutions_GDC_grch38_10_5_relative.rds"))
mtx = t(coef(result))
mtx = mtx[,c(2,4,5,1,3)]
...
write.csv(to_source_data, file = "/Users/matemanczinger/Documents/Projektek/orig_mutational_signatures/results/manuscript/uploaded_files/source_data/Figure_2/A/motif_data.csv", quote = F, row.names = F)
...
writeLines(description, con = "/Users/matemanczinger/Documents/Projektek/orig_mutational_signatures/results/manuscript/uploaded_files/source_data/Figure_2/A/README")
#######################
...
to_source_data = mtx
to_source_data = cbind.data.frame(AAS = paste0("AAS", 1:5), as.data.frame(to_source_data))
write.csv(to_source_data, file = "/Users/matemanczinger/Documents/Projektek/orig_mutational_signatures/results/manuscript/uploaded_files/source_data/Figure_2/B/heatmap_data.csv", quote = F, row.names = F)
...
writeLines(description, con = "/Users/matemanczinger/Documents/Projektek/orig_mutational_signatures/results/manuscript/uploaded_files/source_data/Figure_2/B/README")
...
load("common_objects/MM_tumors_studies.RData") #The object contains the classification of tumor samples to tumor types
...
write.csv(to_source_data, file = "/Users/matemanczinger/Documents/Projektek/orig_mutational_signatures/results/manuscript/uploaded_files/source_data/Figure_2/C/barchart_data.csv", quote = F, row.names = F)
...
writeLines(description, con = "/Users/matemanczinger/Documents/Projektek/orig_mutational_signatures/results/manuscript/uploaded_files/source_data/Figure_2/C/README")
...
ggsave(plot = figure_2, filename = "/Users/matemanczinger/Documents/Projektek/mutational_signatures/clean_mutational_signatures/results/plots/MM_Figure_2.pdf", width = 40, height = 18, units = "cm", dpi = 300)

```

Note: the letter for panel B was manually inserted in Vectornator.
